...
// in exam_mobii/test/repository/repository_test.dart.
...
import 'package:exam_mobii/data/domain/user/user.dart' as _i11;
import 'package:exam_mobii/data/services/user_service.dart' as _i10;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockIUserService extends _i1.Mock implements _i10.IUserService {
  MockIUserService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i8.Future<List<_i11.User>> getUsers() => (super.noSuchMethod(
        Invocation.method(
          #getUsers,
          [],
        ),
        returnValue: _i8.Future<List<_i11.User>>.value(<_i11.User>[]),
      ) as _i8.Future<List<_i11.User>>);
}

/// A class which mocks [HttpResponse].
///
/// See the documentation for Mockito's code generation for more information.
class MockHttpResponse extends _i1.Mock implements _i12.HttpResponse<String> {
  MockHttpResponse() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i6.Response<dynamic> get response => (super.noSuchMethod(
        Invocation.getter(#response),
        returnValue: _FakeResponse_4<dynamic>(
          this,
          Invocation.getter(#response),
        ),
      ) as _i6.Response<dynamic>);
}
